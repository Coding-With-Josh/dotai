  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        green: 'bg-primary-green text-primary-foreground hover:bg-primary-green/90',
        blue: 'bg-primary-blue text-primary-foreground hover:bg-primary-blue/90',
        orange: 'bg-primary-orange text-primary-foreground hover:bg-primary-orange/90',
        purple: 'bg-primary-purple text-primary-foreground hover:bg-primary-purple/90',
      ...
      effect: {
        ...
        underline:
          'relative !no-underline after:absolute after:bg-primary after:bottom-2 after:h-[1px] after:w-2/3 after:origin-bottom-left after:scale-x-100 hover:after:origin-bottom-right hover:after:scale-x-0 after:transition-transform after:ease-in-out after:duration-300 after:underline-white',
        hoverUnderline:
